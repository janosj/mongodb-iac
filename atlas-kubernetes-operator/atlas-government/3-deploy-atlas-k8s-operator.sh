# Deploy Atlas Kubernetes Operator to Atlas for Government

# According to the Quick Start (https://www.mongodb.com/docs/atlas/operator/current/ak8so-for-gov/),
# the KO must be installed using the Atlas CLI with the --gov flag.
